...
# Specifies the `worker_processes` number (usually equals to the number of CPUs):
...
# Workers use the following defaults, unless inline `workers` configuration is used.
#
